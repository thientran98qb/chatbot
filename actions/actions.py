...
class CarAction(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        dispatcher.utter_message(text="Here are few top rated restaurants that I have found 🤩",json_message={"payload":"cardsCarousel","data":details['best_restaurants']})
        return []
class RestaurantHigh(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        print(re_msg)
        details={"best_restaurants":re_msg}
        dispatcher.utter_message(text="These are the restaurants with the highest prices 🤩",json_message={"payload":"cardsCarousel","data":details['best_restaurants']})
        return []
class RestaurantLow(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        print(re_msg)
        details={"best_restaurants":re_msg}
        dispatcher.utter_message(text="These are the restaurants with the lowest prices 🤩",json_message={"payload":"cardsCarousel","data":details['best_restaurants']})
        return []
